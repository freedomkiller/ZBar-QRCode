...
#define linIphone5 CGRectMake((self.view.frame.size.width-250)/2, 125, 250, 2)
#define linIphone4 CGRectMake((self.view.frame.size.width-250)/2, 70, 250, 2)
...
-(void)createView{
    ...
    if (self.view.frame.size.height<500) {
        ...
        _line = [[UIImageView alloc] initWithFrame:linIphone4];
        ...
        _line = [[UIImageView alloc] initWithFrame:linIphone5];
        _line.image = [UIImage imageNamed:@"qrcode_scan_light_green.png"];
        [bgImageView addSubview:_line];
  ...
  //下方相册
    ...
    for (int i=0; i<unSelectImageNames.count; i++) {
        ...
        button.frame=CGRectMake(self.view.frame.size.width/3*i+60, 0, self.view.frame.size.width/3, 100);
    ...
    image.image = [UIImage imageNamed:@"qrcode_scan_titlebar_back_pressed@2x"];
...
-(void)animation1
{
    ...
    [UIView animateWithDuration:2 animations:^{
         ...
         _line.frame = CGRectMake((self.view.frame.size.width-250)/2, 125+240, 250, 2);
    }completion:^(BOOL finished) {
        [UIView animateWithDuration:2 animations:^{
          _line.frame = linIphone5;
        }];
        ...
        [UIView animateWithDuration:2 animations:^{
            ...
            _line.frame = CGRectMake((self.view.frame.size.width-250)/2, 70+200, 250, 2);
        }completion:^(BOOL finished) {
            [UIView animateWithDuration:2 animations:^{
                _line.frame = linIphone4;
            }];
    }];}
}
//开启关闭闪光灯
...
//    _line.frame = CGRectMake((self.view.frame.size.width-250)/2, 125, 250, 2);
    num = 0;
    upOrdown = NO;
